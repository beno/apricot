...
public class WebContext {
	...
	public static void setActiveContext(ServletRequest request, WebContext ctx) {
		RequestContext.getActiveContext(request).put(WebContext.class.getName(), ctx);
	}

	public static WebContext getActiveContext() {
		return (WebContext)RequestContext.getActiveContext().get(WebContext.class.getName());
	}

	public static WebContext getActiveContext(ServletRequest request) {
		return (WebContext)RequestContext.getActiveContext(request).get(WebContext.class.getName());
	}
	...
	public String getMessage(String key, Object ... vars) {
		return getApplication().getMessage(getLocale().getLanguage(), key, vars);
	}
