...
under Tomcat you can use:
  ...
  <Resource name="TransactionManager" auth="Container"
      ...
      factory="org.eclipse.ecr.runtime.jtajca.NuxeoTransactionManagerFactory"
      transactionTimeoutSeconds="300"/>

  <Transaction 
      factory="org.eclipse.ecr.runtime.jtajca.NuxeoUserTransactionFactory"/>

  <Resource name="NuxeoConnectionManager" auth="Container"
      type="javax.resource.spi.ConnectionManager"
      factory="org.eclipse.ecr.runtime.jtajca.NuxeoConnectionManagerFactory"
